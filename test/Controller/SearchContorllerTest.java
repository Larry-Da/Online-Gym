...
public class SearchContorllerTest {
    ...
    public void setUp() {
        ...
        videos.add(new Video("1", "12345", "video1", 3.5, "yoga", 1300, 3500));
        videos.add(new Video("2", "12345", "video2", 3.2, "yoga", 800, 1900));
        videos.add(new Video("3", "12345", "video3", 3.4, "yoga", 1000, 3200));
        videos.add(new Video("4", "12345", "video4", 3.7, "yoga", 1800, 4500));
    }
